...
public class DataUnit extends org.apache.thrift.TUnion<DataUnit, DataUnit._Fields> {
  ...
  static {
    ...
    tmpMap.put(_Fields.PERSON_PROPERTY, new org.apache.thrift.meta_data.FieldMetaData("person_property", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.ycu.tang.msbplatform.batch.thrift.PersonProperty.class)));
    tmpMap.put(_Fields.PAGE_PROPERTY, new org.apache.thrift.meta_data.FieldMetaData("page_property", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.ycu.tang.msbplatform.batch.thrift.PageProperty.class)));
    tmpMap.put(_Fields.EQUIV, new org.apache.thrift.meta_data.FieldMetaData("equiv", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.ycu.tang.msbplatform.batch.thrift.EquivEdge.class)));
    tmpMap.put(_Fields.PAGE_VIEW, new org.apache.thrift.meta_data.FieldMetaData("page_view", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.ycu.tang.msbplatform.batch.thrift.PageViewEdge.class)));
  ...
  public static DataUnit person_property(com.ycu.tang.msbplatform.batch.thrift.PersonProperty value) {
    DataUnit x = new DataUnit();
    x.setPerson_property(value);
    return x;
  }

  public static DataUnit page_property(com.ycu.tang.msbplatform.batch.thrift.PageProperty value) {
    DataUnit x = new DataUnit();
    x.setPage_property(value);
    return x;
  }

  public static DataUnit equiv(com.ycu.tang.msbplatform.batch.thrift.EquivEdge value) {
    DataUnit x = new DataUnit();
    x.setEquiv(value);
    return x;
  }

  public static DataUnit page_view(com.ycu.tang.msbplatform.batch.thrift.PageViewEdge value) {
    DataUnit x = new DataUnit();
  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      case PERSON_PROPERTY:
        if (value instanceof com.ycu.tang.msbplatform.batch.thrift.PersonProperty) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type com.ycu.tang.msbplatform.batch.thrift.PersonProperty for field 'person_property', but got " + value.getClass().getSimpleName());
      case PAGE_PROPERTY:
        if (value instanceof com.ycu.tang.msbplatform.batch.thrift.PageProperty) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type com.ycu.tang.msbplatform.batch.thrift.PageProperty for field 'page_property', but got " + value.getClass().getSimpleName());
      case EQUIV:
        if (value instanceof com.ycu.tang.msbplatform.batch.thrift.EquivEdge) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type com.ycu.tang.msbplatform.batch.thrift.EquivEdge for field 'equiv', but got " + value.getClass().getSimpleName());
      case PAGE_VIEW:
        if (value instanceof com.ycu.tang.msbplatform.batch.thrift.PageViewEdge) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type com.ycu.tang.msbplatform.batch.thrift.PageViewEdge for field 'page_view', but got " + value.getClass().getSimpleName());
      default:
      ...
      switch (setField) {
        case PERSON_PROPERTY:
          if (field.type == PERSON_PROPERTY_FIELD_DESC.type) {
            com.ycu.tang.msbplatform.batch.thrift.PersonProperty person_property;
            person_property = new com.ycu.tang.msbplatform.batch.thrift.PersonProperty();
        ...
        case PAGE_PROPERTY:
          if (field.type == PAGE_PROPERTY_FIELD_DESC.type) {
            com.ycu.tang.msbplatform.batch.thrift.PageProperty page_property;
            page_property = new com.ycu.tang.msbplatform.batch.thrift.PageProperty();
        ...
        case EQUIV:
          if (field.type == EQUIV_FIELD_DESC.type) {
            com.ycu.tang.msbplatform.batch.thrift.EquivEdge equiv;
            equiv = new com.ycu.tang.msbplatform.batch.thrift.EquivEdge();
            equiv.read(iprot);
            return equiv;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
        ...
        case PAGE_VIEW:
          if (field.type == PAGE_VIEW_FIELD_DESC.type) {
            com.ycu.tang.msbplatform.batch.thrift.PageViewEdge page_view;
            page_view = new com.ycu.tang.msbplatform.batch.thrift.PageViewEdge();
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      case PERSON_PROPERTY:
        com.ycu.tang.msbplatform.batch.thrift.PersonProperty person_property = (com.ycu.tang.msbplatform.batch.thrift.PersonProperty)value_;
        person_property.write(oprot);
        return;
      case PAGE_PROPERTY:
        com.ycu.tang.msbplatform.batch.thrift.PageProperty page_property = (com.ycu.tang.msbplatform.batch.thrift.PageProperty)value_;
        page_property.write(oprot);
        return;
      case EQUIV:
        com.ycu.tang.msbplatform.batch.thrift.EquivEdge equiv = (com.ycu.tang.msbplatform.batch.thrift.EquivEdge)value_;
        equiv.write(oprot);
        return;
      case PAGE_VIEW:
        com.ycu.tang.msbplatform.batch.thrift.PageViewEdge page_view = (com.ycu.tang.msbplatform.batch.thrift.PageViewEdge)value_;
  ...
  public com.ycu.tang.msbplatform.batch.thrift.PersonProperty getPerson_property() {
    if (getSetField() == _Fields.PERSON_PROPERTY) {
      return (com.ycu.tang.msbplatform.batch.thrift.PersonProperty)getFieldValue();
    } else {
  ...
  public void setPerson_property(com.ycu.tang.msbplatform.batch.thrift.PersonProperty value) {
    setField_ = _Fields.PERSON_PROPERTY;
    value_ = java.util.Objects.requireNonNull(value,"_Fields.PERSON_PROPERTY");
  }

  public com.ycu.tang.msbplatform.batch.thrift.PageProperty getPage_property() {
    if (getSetField() == _Fields.PAGE_PROPERTY) {
      return (com.ycu.tang.msbplatform.batch.thrift.PageProperty)getFieldValue();
    } else {
  ...
  public void setPage_property(com.ycu.tang.msbplatform.batch.thrift.PageProperty value) {
    setField_ = _Fields.PAGE_PROPERTY;
    value_ = java.util.Objects.requireNonNull(value,"_Fields.PAGE_PROPERTY");
  }

  public com.ycu.tang.msbplatform.batch.thrift.EquivEdge getEquiv() {
    if (getSetField() == _Fields.EQUIV) {
      return (com.ycu.tang.msbplatform.batch.thrift.EquivEdge)getFieldValue();
    } else {
  ...
  public void setEquiv(com.ycu.tang.msbplatform.batch.thrift.EquivEdge value) {
    setField_ = _Fields.EQUIV;
    value_ = java.util.Objects.requireNonNull(value,"_Fields.EQUIV");
  }

  public com.ycu.tang.msbplatform.batch.thrift.PageViewEdge getPage_view() {
    if (getSetField() == _Fields.PAGE_VIEW) {
      return (com.ycu.tang.msbplatform.batch.thrift.PageViewEdge)getFieldValue();
    } else {
  ...
  public void setPage_view(com.ycu.tang.msbplatform.batch.thrift.PageViewEdge value) {
