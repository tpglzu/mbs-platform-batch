...
public class EquivEdge implements org.apache.thrift.TBase<EquivEdge, EquivEdge._Fields>, java.io.Serializable, Cloneable, Comparable<EquivEdge> {
  ...
  public @org.apache.thrift.annotation.Nullable com.ycu.tang.msbplatform.batch.thrift.PersonID id1; // required
  public @org.apache.thrift.annotation.Nullable com.ycu.tang.msbplatform.batch.thrift.PersonID id2; // required
  ...
  public EquivEdge(
    com.ycu.tang.msbplatform.batch.thrift.PersonID id1,
    com.ycu.tang.msbplatform.batch.thrift.PersonID id2)
  {
    this();
    this.id1 = id1;
    this.id2 = id2;
  ...
  public EquivEdge(EquivEdge other) {
    if (other.isSetId1()) {
      this.id1 = new com.ycu.tang.msbplatform.batch.thrift.PersonID(other.id1);
    }
    if (other.isSetId2()) {
      this.id2 = new com.ycu.tang.msbplatform.batch.thrift.PersonID(other.id2);
    }
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public com.ycu.tang.msbplatform.batch.thrift.PersonID getId1() {
    return this.id1;
  }

  public EquivEdge setId1(@org.apache.thrift.annotation.Nullable com.ycu.tang.msbplatform.batch.thrift.PersonID id1) {
    this.id1 = id1;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public com.ycu.tang.msbplatform.batch.thrift.PersonID getId2() {
    return this.id2;
  }

  public EquivEdge setId2(@org.apache.thrift.annotation.Nullable com.ycu.tang.msbplatform.batch.thrift.PersonID id2) {
    this.id2 = id2;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ID1:
      if (value == null) {
        ...
        setId1((com.ycu.tang.msbplatform.batch.thrift.PersonID)value);
      }
      break;
    ...
    case ID2:
      if (value == null) {
        ...
        setId2((com.ycu.tang.msbplatform.batch.thrift.PersonID)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 1: // ID1
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.id1 = new com.ycu.tang.msbplatform.batch.thrift.PersonID();
          ...
          case 2: // ID2
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.id2 = new com.ycu.tang.msbplatform.batch.thrift.PersonID();
